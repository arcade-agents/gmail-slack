...
async def main():
    ...
    arcade_tools = await get_arcade_tools(
        client, tools=['Gmail_ListEmails', 'Gmail_SendEmail'], toolkits=["Slack"]
    )
    ...
    agent = Agent(
        name="",
        instructions="You're a very useful assistant with access to Gmail and Slack tools, please use them to effectively do tasks requested by the user",

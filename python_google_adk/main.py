...
async def main():
    ...
    agent = Agent(
        ...
        name="google_agent",
        instruction="You're a very useful assistant with access to Gmail and Slack tools, please use them to effectively do tasks requested by the user",
        description="An agent with Gmail and Slack tools",
        tools=agent_tools,
